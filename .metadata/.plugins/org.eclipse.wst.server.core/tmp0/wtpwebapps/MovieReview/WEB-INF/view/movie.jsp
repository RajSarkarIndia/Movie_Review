...
<body>
	<ul>
		...
		<li>
			...
			%>
			<a href="LoginCheck.jsp">User Login</a> <a href="AdminLoginCheck.jsp">Admin
				Login</a> <a href="CreateUser.jsp">Create New Account</a> <%
...
%>
	...
	<div class="movie-card">
		<div class="movie-header">
			<img
				src="${pageContext.request.contextPath}/image/${movie.getMovieImageURL()}"
				alt="${movie.getMovieName()}" />
			<div class="movie-info">
				<h2>${movie.getMovieName()}</h2>
				<h3>Movie Rating:</h3>
				<p>${movie.getMovieRating()}/10</p>
				<h3>Released on:</h3>
				<p>${movie.getReleaseDate()}</p>
				<h3>Genre:</h3>
				<p>${movie.getGenre()}</p>
				<h3>Movie Length:</h3>
				<p>${movie.getLength()}minutes</p>
			</div>
		</div>
		<div class="trailer-section">
			<iframe src="https://www.youtube.com/embed/${movie.getTrailer()}"
	...
	<div class="reviews-section">
		...
		%>
		<form action="/MovieReview/addreview" class="review-form">
			<label for="star">Enter Rating (up to 10)</label> <input type="text"
				name="star" required> <label for="review">Enter Your
				Review</label> <input type="text" name="review" required> <input
		...
		%>
		<h4>
			Login to Add Review: <a href="LoginCheck.jsp">Login</a>
		</h4>
		<%
		}
		...
		<div class="review-card">
			...
			<p>
				<b>Rating:</b> ${review.userRating}/10
			</p>
			<p>${review.review}</p>
